...
import { 
    ...
    Inwindow, 
    Socket,
    setAttributes, svgNS, preventDefaults, 
} from '../foundation'
import Geom3d from '../assets/module-assets/geom-3d.png'
import Geom3m from '../assets/module-assets/geom-3m.png'
import GeomUL from "../assets/module-assets/geom-ul.png"
import GeomPause from '../assets/module-assets/geom-pause.png'
import GeomPlay from '../assets/module-assets/geom-play.png'
...
const Geom = { 
    ...
    initGeomWIW() { // [G8]
        ...
        function constructScreen1() { 
            ...
            o.socket = setAttributes(document.createElement("div"),   { id: "geom-socket", class: "geom-border upload-socket hover-button", style: "background-image:url(" + GeomUL + ")", parent: o.form })
        ...
        function constructScreen2() {
            ...
            const iconPause = "url(" + GeomPause + ")"
            const iconPlay = "url(" + GeomPlay + ")"
            const o = {};
