import { Phase, WhiteSettingsBelt, svgNS } from "../foundation"
...
class ƎǃGeom extends CellulartModule {
    ...
    mutation(oldPhase: Phase, newPhase: Phase) {
        ...
        this.geomPreview = document.createElementNS(svgNS, "svg")
                                    .setAttributes([
                                        ["class", "geom-svg"], ["viewBox", "0 0 758 424"], ["width", "758"], ["height", "424"]])
                                    .attachTo(document.querySelector(".core")!)
    }
    backToLobby() {
        this.flags.mode = false; 
